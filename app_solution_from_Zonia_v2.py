...
CORS(app, resources={r"/api/v1.0/top_ten": {"origins": "http://127.0.0.1:5000"}})
CORS(app, resources={r"/api/v1.0/industry_groups": {"origins": "http://127.0.0.1:5000"}})
CORS(app, resources={r"/api/v1.0/top_ten_historic": {"origins": "http://127.0.0.1:5000"}})
CORS(app, resources={r"/api/v1.0/fundamental": {"origins": "http://127.0.0.1:5000"}})
