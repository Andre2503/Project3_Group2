  ...
  try {
    ...
    const fundamentalPromises = filteredTickers.map(async (selectedTicker) => {
      ...
      return {
        ...
        eps: fundamentalData[22], // Adjust the index based on your data structure
        pe: fundamentalData[26], // Adjust the index based on your data structure
      };
    });
    ...
    // Step 10: Update the bar charts with the fetched data
